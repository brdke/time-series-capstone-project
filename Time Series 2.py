...
maize_img = Image.open("images/maize.jpg")
bread_img = Image.open("images/bread.jpg")
oil_img = Image.open("images/oil.jpg")
milk_img = Image.open("images/milk.jpg")
diesel_img = Image.open("images/diesel.jpg")
gasoline_img = Image.open("images/gasoline.jpg")
inflation_img = Image.open('images/inflation.jpg')
buy_img = Image.open("images/dollar.jpg")
